...
grammar = {
    ...
    "patterns": [
        ...
        {"begin": "\\(", "end": "\\)", "name": "comment.block.paren.syntec-macro"},
        {"match": "\\b(M99|M30|M02)\\b", "name": "keyword.control.end.syntec-macro"},
        {"match": "\\b(IF|THEN|ELSE|ELSEIF|END_IF)\\b", "name": "keyword.control.conditional.syntec-macro"},
        {"match": "\\b(REPEAT|UNTIL|END_REPEAT)\\b", "name": "keyword.control.repeat.syntec-macro"},
        {"match": "\\b(WHILE|DO|END_WHILE)\\b", "name": "keyword.control.while.syntec-macro"},
        {"match": "\\b(FOR|TO|BY|END_FOR)\\b", "name": "keyword.control.for.syntec-macro"},
        {"match": "\\b(CASE|OF|END_CASE)\\b", "name": "keyword.control.case.syntec-macro"},
        ...
        {"match": "\\b(STR2INT|SCANTEXT)\\b", "name": "support.function.string.syntec-macro"},
        {"match": "\\b(OPEN|CLOSE|PRINT|GETARG|GETTRAPARG|PARAM)\\b", "name": "support.function.io.syntec-macro"},
        {"match": "\\b(READDI|READDO|READABIT|SETDO|SETABIT|READRREGBIT|SETRREGBIT)\\b", "name": "support.function.io.rw.syntec-macro"},
        {"match": "\\b(DBOPEN|DBCLOSE|DBNEW|DBLOAD|DBSAVE|DBINSERT|DBDELETE)\\b", "name": "support.function.db.syntec-macro"},
        {"match": "\\b(ALARM|MSG|WAIT|SLEEP|SYSVAR|SYSDATA|DRVDATA|STD|STDAX)\\b", "name": "support.function.system.syntec-macro"},
        {"match": "\\b(CHKMN|CHKSN|CHKMT|CHKMI|CHKINF)\\b", "name": "support.function.check.syntec-macro"},
        {"match": "\\b(PUSH|POP|STKTOP|AXID|INT)\\b", "name": "support.function.misc.syntec-macro"},
        ...
        {"match": "#[A-Za-z_][A-Za-z0-9_]*|#\\d+|#\\[[^\\]]+\\]", "name": "variable.language.local.syntec-macro"},
        ...
        {"match": "\\bN\\d+\\b", "name": "entity.name.label.syntec-macro"},
...
out = os.path.join(os.path.dirname(__file__), "syntaxes", "syntec-macro.tmLanguage.json")
